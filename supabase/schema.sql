...
create index documents_customer_name_hash_idx on public.documents(customer_name_hash);
create index documents_phone_last4_hash_idx on public.documents(phone_last4_hash);
create index documents_recipient_phone_hash_idx on public.documents(recipient_phone_hash);
